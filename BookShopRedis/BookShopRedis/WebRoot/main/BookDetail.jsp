    ...
    <table align="center" width=90%>
  		...
  		<td>
  			<table border="1" width=100%>        			
       			...
       			<tr><td colspan=3 align=center><a href="<%=basePath%>ShopCarAddSvl?isbn=${book.isbn}">加入购物车</a>  
       			     &nbsp; <a href="<%=basePath%>BookCommentSvl?isbn=${book.isbn}">评论</a>
       			     &nbsp;&nbsp;&nbsp;&nbsp; <a href="<%=basePath%>MainSvl2">返回</a>
       			     </td> </tr>	
    		</table>  		
  		</td>
  		</tr>	
